...
const App = () => {
  ...
  useEffect( async () => {
    ...
    // items це назва масиву з прикладу
    // filter це в стейті нову властивість бажано би було зробити яка по дефолту ALL і мінятись статус того мав би через компоненту з кнопками
    //  const visibleItems =  filterItems(data.tododata,data.filter)
